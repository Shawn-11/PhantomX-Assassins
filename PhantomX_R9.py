...
def Route9(laura: Laura):
    ...
    laura.gyro_lock_turn(LEFT_DRIVE, 0, stop=False)
    laura.gyro_lock_turn(RIGHT_DRIVE, -50, stop=False)
    ...
    laura.adapter_motor_seconds(RIGHT_ADAPTER, 1000, 2600)
    # laura.gyro_acc(-80, 80, stop=False)
    # laura.gyro_lock_turn(RIGHT_DRIVE, -56, False)
    # laura.gyro_acc(-80, 700, -56, stop=False)
    # laura.gyro_point_turn(-160)
    # laura.adapter_motor_seconds(RIGHT_ADAPTER, -1000, 2200)
    # laura.gyro_point_turn(0, True, 90, 0)
    laura.gyro_acc(power= -60 , distance= 100 , angle= -90, stop=False)
    laura.gyro_point_turn(angle= -230, stop=False)
    laura.gyro_acc(power= 80 , distance= 320 , angle= -230, stop=False)
    laura.adapter_motor_seconds(port= RIGHT_ADAPTER , speed= -1000 , duration= 3000 ,wait_complete=False)
    laura.gyro_lock_turn(port= LEFT_DRIVE , angle= -195)
    wait(100)
    laura.gyro_acc(power= -60 , distance= 50 , angle= -190)
